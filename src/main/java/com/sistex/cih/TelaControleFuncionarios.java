...
public class TelaControleFuncionarios extends TelaAbstract{
    ...
    public void montacampos(PrintWriter pw, String titulo) {
        ...
        criaCampo(pw, "nome", "Nome do funcionário");
        criaCampo(pw, "matricula", "Sua matrícula");
        criaCampo(pw, "cpf", "Seu cpf");
        criaCampo(pw, "senha", titulo);
        criaCampoOculto(pw, "tipo","funcionario");
        criaCampoOculto(pw, "operacao", "cadastro");
        criaBotao(pw, "Cadastrar Funcionario");
        pw.println("</form>");
        pw.println("</section>");
    }
