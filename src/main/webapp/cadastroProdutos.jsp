...
<!-- Formulario de cadastro  -->
        <section class="newsletter container bg-grey">
            ...
            <form method="post" action="CadastroProduto" onsubmit="mensagem();">
                ...
                <input class="bg-white radius campo" type="text"   name="qt_unitario" placeholder="Quantidade Unitária" required>
